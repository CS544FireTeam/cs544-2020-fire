  ...
  mockData: CourseItem[] = [
    {
      ...
      code: 'CS 109',
      abbr: 'MICROS Tour',
      name: 'Meeting with Compro students at MICROS company',
      description: 'Meeting with Compro students at MICROS company',
      isChecked: false,
    },
    {
      id: 2,
      code: 'CS 110',
      abbr: 'ICC Tour',
      name: 'Meeting with Compro students at ICC, Ohio',
      description: 'Meeting with Compro students at ICC, Ohio',
      isChecked: false,
    },
    {
      id: 3,
      code: 'CS000',
      abbr: 'JSearch',
      name: 'Job Search (Sept 04 students only)',
      description: 'Full-time Job Search',
      isChecked: false,
    },
    {
      code: 'CS108',
      abbr: 'Des Moines Trip',
      name: 'Meeting with Compro Students by Dr. Gregory and Elaine Guthrie',
      description: 'Meeting with Compro Students by Dr. Gregory and Elaine Guthrie',
      isChecked: false,
    },
    {
      code: 'CS208',
    ...
    {code: 'CS220', abbr: 'Data Structures', name: 'Data Structures', description: 'NULL', isChecked: false,},
    {
      ...
      description: 'Fundamentals of OO Programming',
      isChecked: false,
    },
    {
      code: 'CS401',
    ...
    },
    {
      ...
      description: 'This course will cover the most current emerging methods, principles, and practices in',
      isChecked: false,
    },
    {
      code: 'CS456',
      ...
      description: 'The process of analyzing a software item to detect the differences between existing and required conditions (that is bugs) and to evaluate the features of the software items. [IEEE Standard 610.12-1990]',
      isChecked: false,
    },
    {
      code: 'CS465',
    ...
    {code: 'CS490', abbr: 'Seminar', name: 'Seminar', description: 'Computer Science Seminar', isChecked: false,},
    {
      code: 'CS490-01',
      abbr: 'Rules Engines',
      name: 'Building Rules Engines For Business Applications',
      description: 'In this seminar, we will examine current industry trends in managing business rules. We will discuss pros and cons of externalizing rules and the emerging industry standards for implementation of a rules engine. The course will provide hands-on experience with a medium-scale rules engine.',
      isChecked: false,
    },
  ]
  ;
